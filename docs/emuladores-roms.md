...
- Reconhece e mantém a herança de numerosos videogames retrô de vários sistemas e gêneros.
...
### 🔗 [Ryujinx](https://ryujinx-emulator.com) • Switch

- **Versão original não é mais desenvolvida.** Este emulador se esforça para oferecer precisão e desempenho excelentes, com uma interface de usuário simples.
- [Resultados de segurança da URL](https://www.urlvoid.com/scan/ryujinx-emulator.com)
...
- ROMs e ISOs para múltiplos sistemas com download direto do site.
...
- Oferece alguns jogos traduzidos e dublados (fã-dubs) em PT-BR para PS1, PS2 e PS3.
...
- Uma extensa variedade de ROMs e ISOs para vários sistemas diferentes.
...
- Oferece manualmente a lista dos melhores jogos mais amplamente aceita.
- [Resultados de segurança da URL](https://www.urlvoid.com/scan/archive.org)
...
### [ROMs Português](https://romsportugues.com)
