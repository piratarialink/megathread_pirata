...
### 🔗 [Mesen](https://github.com/nesdev-org/MesenCE) • Game Boy + NES + SNES

- Construído em C++ e C#, emulador multissistema com debugger próprio e compatível com Windows e MacOS.
...
- A BIOS pode ser encontrada na megathread do [r/Roms](https://r-roms.github.io/Miscellaneous/bios-files), [Emulation Lair](https://vimm.net/emulate) (localize na página o link escrito "PS2 BIOS") ou na [Wiki Geral de Emulação](https://emulation.gametechwiki.com/index.php/Emulator_Files).
...
- Fundado em fevereiro de 2009, trata-se de um acervo com milhares de jogos retrô e vintage que foram salvos ao longo dos anos.
