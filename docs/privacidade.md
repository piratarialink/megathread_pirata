...
Bisq é uma aplicação de código aberto exclusiva para desktop que permite que você troque moedas fiduciárias (via PIX do Brasil ou SEPA para residentes de Portugal) por bitcoin, monero e etherum; funciona somente com o serviço Tor que a propósito já vem integrado após a instalação do cliente.
