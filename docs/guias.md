...
Guia para instalar plugins no qBitTorrent, permitindo fazer buscas de fontes seguras de diversos indexadores. Os plugins funcionam como um "rastreador BitTorrent" completo e organizam todos os seus sites de torrents favoritos em um só lugar, tornando as buscas mais rápidas do que visitar cada site separadamente.
