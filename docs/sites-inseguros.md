...
| GOG Unlocked              | gogunlocked-com                                                 | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).         |
| NexusGames                | nexus-games-net                                                 | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).         |
| nosTeam                   | nosteamgames-ro                                                 | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).         |
| "Ovagames"                | ovagames-net                                                    | **Clone falso**: (_Criado para enganar usuários de propósito_).                              |
| Repack-Games              | repack-games-com                                                | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).         |
| 💩 TLauncher              | tlauncher-org                                                  | **Comportamento antiético** (_Provável spyware de origem suspeita_).                         |
| Steam-Repacks             | steam-repacks-com                                               | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).         |
| Worldofpcgames            | worldof-pcgames-net                                             | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).         |
...
| HaxPC                          | haxpc-net                                  | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).                                      |
| 4download                        | 4download-net                                | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).                              |
| KoLomPC                        | kolompc-com                                | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).                                      |
| Portable4PC                    | portable4pc-com                            | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).                                      |
| MicroTech                  | programs-themicrotech-net                              | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).                                   |
| 💩 Cybermania                  | cybermania-ws                              | **Comportamento antiético** (_Inserção de trojan de acesso remoto de forma planejada_).                                   |
| Sample Drive                   | sampledrive-in                             | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).                                      |
| VFXdownload                    | vfxdownload-com                            | **Comportamento antiético** (_Inserção de vírus e rastreadores de forma planejada_).                                      |
