# 📱 ➜ [Megathread](https://rentry.co/Pirataria-MegathreadBR) / Mobile
...
### -> 5. 📑 [Lojas e repositórios de aplicativos crackeados/modificados](#lojas-e-repositórios-de-aplicativos-crackeadosmodificados) <-
### -> 6. 📑 [Grupos/Canais no Telegram](#gruposcanais-no-telegram) <-
...
!!! info
	 ...
	 ➜ Confira nossa thread sobre ⚙️ [Software](https://rentry.co/MegathreadBR-Software)
